...
_C.SOLVER.SFDA_WEIGHT_S3 = 1
_C.SOLVER.SFDA_DIS_FUNC = "sum"
_C.SOLVER.SFDA_TEST_PREDICTOR = "student"
_C.SOLVER.SFDA_DROPOUT_RATIO = 0.

# Choose the update part for the student model
_C.SOLVER.SFDA_UPDATE_PART = "both"
# Confidence for the pseudo label threshold 
_C.SOLVER.SFDA_PSEUDO_TH = 0.8
_C.SOLVER.UNCERTAINTY_EPSILON = 0.4 # a epsilon value added to the uncertainty
# For EMA
_C.SOLVER.SFDA_TEACHER_UPDATE_ITER = 1
_C.SOLVER.SFDA_EMA_KEEP_RATE = 0.999
# For loss
_C.SOLVER.SFDA_REG_ON = True
_C.SOLVER.SFDA_CTR_ON = False
# For the GAN
_C.SOLVER.GAN_EACH_IMAGE_ITER = 300
# For the flow
_C.SOLVER.FLOW_SAMPLES = 10
_C.SOLVER.MTR_ON = True
_C.SOLVER.SFDA_STUDENT_UPDATE_ITER = 1000
_C.SOLVER.ADAM = False
_C.SOLVER.UGOB = True
